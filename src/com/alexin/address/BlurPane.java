...
public class BlurPane extends StackPane 
{
	...
	protected void layoutChildren()
	{
		...
		if(getParent() != null && isVisible())
		{
			...
			Point2D startPoint = this.localToScene(0,0);
			
			Rectangle2D toPaint = new Rectangle2D(startPoint.getX(), startPoint.getY(), getLayoutBounds().getWidth(), getLayoutBounds().getHeight());
